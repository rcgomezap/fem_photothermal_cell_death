...
def solve(V,msh,T,v,ds,dx,tau_q,tau_t,k,rho,c,w,Qmet,blood,Qs_func,h,bc,Ti,Tref,dt,tf,dir,coords,regions_bc,postprocess=True):
    ...
    def get_forms():
        ...
        L = ( tau_q*(2*T_j - T_old)*rho*c*v*r*dx
            ...
            + dt*tau_q*inner((Qs-Qs_old),v)*r*dx
            )
